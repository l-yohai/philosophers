...
/*   Updated: 2020/08/16 03:46:23 by yohlee           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int		init_thread(t_philo **philo, t_semaphore *sem, int num)
{
	int			i;
	...
	if (sem->fork == SEM_FAILED || sem->write == SEM_FAILED || sem->global_died == SEM_FAILED || sem->global_satiated == SEM_FAILED)
